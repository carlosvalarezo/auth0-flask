...
def callback_handling():
    ...
    call_api(token, "/api/v1/protected_admins")
    call_api(token, "/api/v1/protected_admin_readers")
...
@app.route('/api/v1/protected_admins')
@requires_authorization_with_permissions('get:greetings')
def for_admins(jwt):
    return f'Oh happy day admin!'


@app.route('/api/v1/protected_admin_readers')
@requires_authorization_with_permissions('get:greetings_readers')
def for_readers(jwt):
    return f'Oh happy day reader!'
